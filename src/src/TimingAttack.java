...
public class TimingAttack {
    ...
    public static String findPassword(String user) throws Exception {
        ...
        String POSSIBLE_PASSWORD_CHARACTERS = "abcdefghijklmnopqrstuvwxyz";
        String confFormat =
        ...
        System.out.println(String.format("Total running time: %d minutes", (long) (nanoToMilli(endTime - startTime) / 1000 / 60)));
